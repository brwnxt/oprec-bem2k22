                  ...
                  <div class="row">
                    ...
                    <table class="table-custom mb-3">
                      ...
                      <tr>
                        <td>
                          <p class="text-justify">
                          Saya, <?= $data['nama_lengkap']; ?>, telah mengisi formulir pendaftaran untuk mengikuti seleksi menjadi pengurus BEM FIKTI Universitas Gunadarma periode 2022/2023 dengan informasi yang sebenar-benarnya dan lengkap serta dapat dipertanggungjawabkan.
                          </p>
                          <p class="text-justify">

    ...
    <div class="container">
        <div class="row align-items-center pt-5">
            ...
            <h4 class="text-center mb-5" style="color:#54337e;font-family: 'Bree Serif', serif;">OPEN RECRUITMENT BEM FIKTI GUNADARMA UNIVERSITY 2022/2023</h4>
                <h4 class="text-center mb-5" style="color:#54337e;font-family: 'Bree Serif', serif;" >LOGIN</h4>
                <form action="config/login.php" method="POST">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 mx-auto mb-4">
                            <button class="btn btn-primary btn-block py-2 font-weight-bold" type="submit" name="submit" style="font-family: 'Bree Serif', serif;">LOGIN</button>
                            <h5 class="text-center pt-3 pb-5" style="font-family: 'Bree Serif', serif;"> Belum memiliki akun ? <a href="register-acc.php" style="font-family: 'Bree Serif', serif;"> Sign Up </a> </h5>
                        </div>
                    </div>
                </form>
            </div>

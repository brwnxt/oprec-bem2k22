        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper" style="padding: 20px 20px 0px 20px !important; ">
                    <div class="mb-5">
                        <h3 class="text-white mb-4">Riwayat Organisasi</h3>
                        <table id="example2" class="table table-bordered table-hover dt-responsive nowrap text-center"
                            ...
                            <tbody>
                                <?php 
                            $no = 1;
                                $sql = mysqli_query($con, "SELECT * FROM users_history_organization WHERE email = '$_SESSION[email]' ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../../../config/delete_history_organisasi.php?id_ho=<?php echo $datas['id_ho'];?>"
                        ...
                        <!--    href="tambah_data_organisasi.php" role="button">Tambah Data</a>-->
                    </div>

                    <!-- Riwayat Kepanitiaan -->
                    <div class="mt-5">
                        <h3 class="text-white pt-5">Riwayat Kepanitiaan</h3>
                        <table id="example" class="table table-bordered table-hover dt-responsive nowrap text-center"
                            ...
                            <tbody>
                                <?php 
                            $no = 1;
                                $sql = mysqli_query($con, "SELECT * FROM users_history_organizer WHERE email = '$_SESSION[email]' ");
                                while($datas = mysqli_fetch_array($sql)){
                            ?>
                                <tr>
                                    <!-- <td class="text-center">1</td> -->
                                    ...
                                    <td><?php echo $datas[4]; ?></td>
                                    <td>
                                        <a href="../../../config/delete_history_organizer.php?id_organizer=<?php echo $datas['id_organizer'];?>"
                                            class="btn btn-primary">Delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <!--<a class="btn btn-custom-submit btn-fw mt-3 mb-5 float-right col-4 rounded-lg font-button"-->
                        <!--    href="tambah_data_organizer.php" role="button">Tambah Data</a>-->
                    </div>
                </div>

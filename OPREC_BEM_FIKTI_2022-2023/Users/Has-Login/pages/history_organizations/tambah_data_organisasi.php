                ...
                <div class="content-wrapper" style="padding: 20px 20px 0px 20px !important; ">
                    <form action="../../../config/tambah_organisasi.php" method="post">
                        <div class="card card-header mt-4" style="border-radius: 5px !important; ">
                            <h4 class="card-description mb-2">Tambah Riwayat Organisasi</h4>
                            <div class="card-body" style="padding: 10px 0px 0px 0px !important; ">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <h6 class="col-sm-12 col-form-label">Nama Organisasi</h6>
                                            <div class="col-sm-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <h6 class="col-sm-12 col-form-label">Jabatan</h6>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="ho_jabatan"
                                                    placeholder="Jabatan"
                                                    style="border: none !important; border-bottom: 2px solid rgb(120, 1, 255) !important; padding: 0px 0px 0px 5px;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="ho_periode"
                        ...
                        <button type="submit" name="tambah_organisasi"

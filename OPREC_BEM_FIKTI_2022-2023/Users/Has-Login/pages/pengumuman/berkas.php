        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper" style="padding: 20px 20px 0px 20px !important; background-color: #9546fa;">
                    <h1 class="text-white mb-4"> Hasil Seleksi Berkas</h1>
                    <?php 
                    if ($berkas_check == 1) { ?>
                            ...
                            <div class="col-md-12 stretch-card grid-margin">
                                <div class="card bg-gradient-danger card-img-holder text-white"
                                    ...
                                    <div class="card-body" style="border-radius: 20px !important;">
                                        <h2>Terima kasih <?= $_SESSION['nama_lengkap']; ?> atas partisipasinya pada kegiatan Open Recruitment
                                            Staff BEM FIKTI UG Periode 2022/2023. 
                                            <br>
                                            <br>
                                            Mohon maaf, Anda belum lolos pada Tahap
                                            Seleksi Berkas. Tetap semangat dan jangan putus asa. Masih ada kesempatan lain
                                            yang menanti. s</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    <?php }elseif ($berkas_check == 2) {?>
                            ...
                            <div class="col-md-12 stretch-card grid-margin">
                                <div class="card bg-gradient-info card-img-holder text-white"
                                    ...
                                    <div class="card-body" style="border-radius: 20px !important;">
                                        ...
                                        <h3>Berkas Anda telah lolos dalam tahap seleksi berkas</h3>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <h4 for="exampleInputName1">Foto Formal</h4>
                                                    <a href="<?php echo "../../../../berkas_calon/file_foto/".$foto_formal; ?>"
                                                        style="color: #3d51ff; font-weight: unset;" class="h4" download>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <h4 for="exampleInputName1">KRS Semester ATA 2020/2021</h4>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <h4 for="exampleInputName1">Rangkuman Nilai Terakhir</h4>

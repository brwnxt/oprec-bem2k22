        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper" style="padding: 20px 20px 0px 20px !important; ">
                    <form action="../../../config/tambah_akademik.php" method="post">
                        <div class="card card-header mt-4" style="border-radius: 5px !important; ">
                            <h4 class="card-description mb-2">Tambah Point Non Akademik</h4>
                            <div class="card-body" style="padding: 10px 0px 0px 0px !important; ">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <h6 class="col-sm-12 col-form-label">Prestasi</h6>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="na_prestasi"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <h6 class="col-sm-12 col-form-label">Tingkat</h6>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="na_tingkat"
                                                    placeholder="Tingkat"
                                                    style="border: none !important; border-bottom: 2px solid rgb(120, 1, 255) !important; padding: 0px 0px 0px 5px;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <h6 class="col-sm-12 col-form-label">Tahun</h6>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="na_tahun"
                                                    placeholder="Tahun"
                                                    style="border: none !important; border-bottom: 2px solid rgb(120, 1, 255) !important; padding: 0px 0px 0px 5px;">
                                            </div>
                                        </div>
                        ...
                        <button type="submit" name="tambah_non_academic"

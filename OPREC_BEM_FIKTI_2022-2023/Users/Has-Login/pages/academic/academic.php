                ...
                <div class="content-wrapper" style="padding: 20px 20px 0px 20px !important; ">
                    <form action="../../../config/tambah_akademik.php" method="post">
                        <div class="card card-header mt-4" style="border-radius: 5px !important; ">
                            <h4 class="card-description mb-2">Tambah Point Akademik</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="a_prestasi"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="a_tingkat"
                                                    placeholder="Tingkat"
                                                    style="border: none !important; border-bottom: 2px solid rgb(120, 1, 255) !important; padding: 0px 0px 0px 5px;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="a_tahun"
                                                    placeholder="Tahun"
                                                    style="border: none !important; border-bottom: 2px solid rgb(120, 1, 255) !important; padding: 0px 0px 0px 5px;">
                                            </div>
                                        </div>
                        ...
                        <button type="submit" name="tambah_academic"

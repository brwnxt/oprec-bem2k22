                        ...
                        <div class="col-12 grid-margin">
                            ...
                            <!--    enctype="multipart/form-data">-->
                                ...
                                <div class="card card-header" style="border-radius: 15px !important; ">
                                    <h3 class="card-description mb-2 text-muted">Pilihan</h3>
                                    <span>
                                        <!--<a class="float-right rounded-lg font-button text-right mt-n4"-->
                                        <!--    href="update_pilihan.php?email=<?php echo $_SESSION['email'];?>"-->
                                    ...
                                    <div class="card-bg-customs ">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea1" rows="7"
                                            ...
                                            disabled> <?php echo $reason; ?> </textarea>
                                    </div>
                                    ...
                                    <div class="card-bg-customs mt-4 mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea1" rows="7"
                                            style="width: 100%; border: 1px solid rgb(120, 1, 255) !important; border-radius: 5px; padding: 5px 0px 0px 5px;"
                                            disabled> <?php echo $motivations; ?> </textarea>
                                    </div>
                                </div>
                                <!--<input type="text" name="email" value="<?php echo $email; ?>" hidden>-->
                                <!--<a class="btn btn-custom-submit btn-fw mt-4 mb-n3 float-right col-4 rounded-lg font-button"-->
                                <!--    href="update_pilihan.php?email=<?php echo $_SESSION['email'];?>" role="button">Edit-->
                                <!--    Data</a>-->
                            <!--</form>-->
                        </div>
                    </div>
